...
alias mathrun='ecrlogin && docker run -d --name=mathgame --publish=5000:5000 --env-file ./.env --restart unless-stopped 640016856401.dkr.ecr.ap-southeast-2.amazonaws.com/mathgame:latest'
