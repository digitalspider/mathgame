...
docker tag mathgame:latest 640016856401.dkr.ecr.ap-southeast-2.amazonaws.com/mathgame:build-9
docker push 640016856401.dkr.ecr.ap-southeast-2.amazonaws.com/mathgame:build-9
